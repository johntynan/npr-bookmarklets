	...
	if ($("#wikiframe").length == 0) {
		...
		if ((s != "") && (s != null)) {
			...
			<div id='wikiframe'>\
				...
				<iframe src='http://api.npr.org/query?&searchTerm="+s+"&dateType=story&output=html&apiKey=MDAxNzgwMDQ5MDEyMTQ4NzYyMjU4YmY1Yw004' onload=\"$('#wikiframe iframe').slideDown(500);\">Enable iFrames.</iframe>\
				<style type='text/css'>\
					#wikiframe_veil { display: none; position: fixed; width: 100%; height: 100%; top: 0; left: 0; background-color: rgba(255,255,255,.98); cursor: pointer; z-index: 900; }\
